...
module NIOSSystem_mm_interconnect_0 (
	...
	wire  [96:0] cmd_mux_003_src_data;                                                                      // cmd_mux_003:src_data -> led_s1_agent:cp_data
	...
	wire  [96:0] cmd_mux_004_src_data;                                                                      // cmd_mux_004:src_data -> timer_s1_agent:cp_data
	...
	wire  [96:0] cmd_mux_005_src_data;                                                                      // cmd_mux_005:src_data -> hex0_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                                     // hex0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [13:0] cmd_mux_005_src_channel;                                                                   // cmd_mux_005:src_channel -> hex0_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_006_src_data;                                                                      // cmd_mux_006:src_data -> hex1_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                                     // hex1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [13:0] cmd_mux_006_src_channel;                                                                   // cmd_mux_006:src_channel -> hex1_s1_agent:cp_channel
	...
	wire  [13:0] cmd_mux_007_src_channel;                                                                   // cmd_mux_007:src_channel -> hex2_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_008_src_data;                                                                      // cmd_mux_008:src_data -> hex3_s1_agent:cp_data
	...
	wire  [96:0] cmd_mux_009_src_data;                                                                      // cmd_mux_009:src_data -> hex4_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                                     // hex4_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [13:0] cmd_mux_009_src_channel;                                                                   // cmd_mux_009:src_channel -> hex4_s1_agent:cp_channel
	...
	wire  [13:0] cmd_mux_010_src_channel;                                                                   // cmd_mux_010:src_channel -> hex5_s1_agent:cp_channel
	...
	wire         cmd_mux_011_src_valid;                                                                     // cmd_mux_011:src_valid -> button_s1_agent:cp_valid
	wire  [96:0] cmd_mux_011_src_data;                                                                      // cmd_mux_011:src_data -> button_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                                     // button_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [13:0] cmd_mux_011_src_channel;                                                                   // cmd_mux_011:src_channel -> button_s1_agent:cp_channel
	wire         cmd_mux_011_src_startofpacket;                                                             // cmd_mux_011:src_startofpacket -> button_s1_agent:cp_startofpacket
	wire         cmd_mux_011_src_endofpacket;                                                               // cmd_mux_011:src_endofpacket -> button_s1_agent:cp_endofpacket
	...
	wire  [96:0] cmd_mux_012_src_data;                                                                      // cmd_mux_012:src_data -> switch_s1_agent:cp_data
	...
	wire         cmd_mux_013_src_valid;                                                                     // cmd_mux_013:src_valid -> onchip_memory_s1_agent:cp_valid
	wire  [96:0] cmd_mux_013_src_data;                                                                      // cmd_mux_013:src_data -> onchip_memory_s1_agent:cp_data
	wire         cmd_mux_013_src_ready;                                                                     // onchip_memory_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire  [13:0] cmd_mux_013_src_channel;                                                                   // cmd_mux_013:src_channel -> onchip_memory_s1_agent:cp_channel
	wire         cmd_mux_013_src_startofpacket;                                                             // cmd_mux_013:src_startofpacket -> onchip_memory_s1_agent:cp_startofpacket
	wire         cmd_mux_013_src_endofpacket;                                                               // cmd_mux_013:src_endofpacket -> onchip_memory_s1_agent:cp_endofpacket
	...
	wire  [96:0] led_s1_agent_rp_data;                                                                      // led_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [96:0] timer_s1_agent_rp_data;                                                                    // timer_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [96:0] hex0_s1_agent_rp_data;                                                                     // hex0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [96:0] hex1_s1_agent_rp_data;                                                                     // hex1_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [96:0] hex3_s1_agent_rp_data;                                                                     // hex3_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [96:0] hex4_s1_agent_rp_data;                                                                     // hex4_s1_agent:rp_data -> router_011:sink_data
	...
	wire         button_s1_agent_rp_valid;                                                                  // button_s1_agent:rp_valid -> router_013:sink_valid
	wire  [96:0] button_s1_agent_rp_data;                                                                   // button_s1_agent:rp_data -> router_013:sink_data
	wire         button_s1_agent_rp_ready;                                                                  // router_013:sink_ready -> button_s1_agent:rp_ready
	wire         button_s1_agent_rp_startofpacket;                                                          // button_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire         button_s1_agent_rp_endofpacket;                                                            // button_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire  [96:0] switch_s1_agent_rp_data;                                                                   // switch_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [96:0] onchip_memory_s1_agent_rp_data;                                                            // onchip_memory_s1_agent:rp_data -> router_015:sink_data
	...
	wire  [96:0] cmd_demux_001_src1_data;                                                                   // cmd_demux_001:src1_data -> cmd_mux_013:sink1_data
	...
	wire  [96:0] rsp_demux_013_src1_data;                                                                   // rsp_demux_013:src1_data -> rsp_mux_001:sink1_data
	...
	wire         button_s1_agent_rdata_fifo_src_valid;                                                      // button_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire  [33:0] button_s1_agent_rdata_fifo_src_data;                                                       // button_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire         button_s1_agent_rdata_fifo_src_ready;                                                      // avalon_st_adapter_011:in_0_ready -> button_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_011_out_0_valid;                                                         // avalon_st_adapter_011:out_0_valid -> button_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_011_out_0_data;                                                          // avalon_st_adapter_011:out_0_data -> button_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_011_out_0_ready;                                                         // button_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire   [0:0] avalon_st_adapter_011_out_0_error;                                                         // avalon_st_adapter_011:out_0_error -> button_s1_agent:rdata_fifo_sink_error
	...
	NIOSSystem_mm_interconnect_0_router_003 router_007 (
	...
	NIOSSystem_mm_interconnect_0_router_004 router_015 (
	...
	NIOSSystem_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_clk_clk),                                         //       clk.clk
		.reset               (accelerometer_spi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSSystem_mm_interconnect_0_cmd_mux_002 cmd_mux_013 (
		.clk                 (clk_clk_clk),                                         //       clk.clk
		.reset               (accelerometer_spi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSSystem_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_clk_clk),                                         //       clk.clk
		.reset              (accelerometer_spi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSSystem_mm_interconnect_0_rsp_demux_002 rsp_demux_013 (
		.clk                (clk_clk_clk),                                         //       clk.clk
		.reset              (accelerometer_spi_reset_reset_bridge_in_reset_reset), // clk_reset.reset
